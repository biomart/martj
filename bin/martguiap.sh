...
# arp
# Special flags to pass to java.
SPECIAL_FLAGS='-Dcom.apple.laf.userScreenMenuBar="true" -Dcom.apple.mrj.application.apple.menu.about.name=MartExplorer'
# arp
...
#java -cp $TMP_CLASSPATH $SPECIAL_FLAGS org.ensembl.mart.explorer.QueryEditor $@
java -cp $TMP_CLASSPATH $SPECIAL_FLAGS org.ensembl.mart.explorer.MartExplorer $@
