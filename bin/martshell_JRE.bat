...
SET TMP_CLASSPATH=%TMP_CLASSPATH%;%TMP_ROOT%\lib\mysql-connector-java-3.0.16-ga-bin.jar
...
SET TMP_CLASSPATH=%TMP_CLASSPATH%;%TMP_ROOT%\lib\pg73jdbc3.jar
SET TMP_CLASSPATH=%TMP_CLASSPATH%;%TMP_ROOT%\lib\ojdbc14.jar
SET TMP_CLASSPATH=%TMP_CLASSPATH%;%TMP_ROOT%\lib\jline.jar
