...
# Starts the MartShell GUI application.
...
echo "Starting MartShell please wait .... " 

#java -ea -cp $TMP_CLASSPATH org.ensembl.mart.editor.MartShell $@
...
java -Xmx128m -Xms128m -ea -cp "$TMP_CLASSPATH" org.ensembl.mart.shell.MartShell $@
