...
/**
 * Outputs coding sequence in tabulated output format, with the sequence as the last field in the output.
 * 
 * @author <a href="mailto:dlondon@ebi.ac.uk">Darin London</a>
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public final class TabulatedCodingSeqQueryRunner implements QueryRunner {

	/**
	 * Constructs a TabulatedCodingSeqQueryRunner object to execute a Query
	 * and print tabulated output of Coding Sequences
	 * 
	 ...
	 */
	public TabulatedCodingSeqQueryRunner(Query query, FormatSpec format, Connection conn, OutputStream os) {
	   this.query = query;
	   this.format = format;
	   this.conn = conn;
	   this.os = os;
