...
public class TabulatedAttributeQueryRunner implements QueryRunner {
     ...
     */
    public TabulatedAttributeQueryRunner(Query query, FormatSpec format, Connection conn, OutputStream os) {
        this.query = query;
        this.format = format;
        this.conn = conn;
        this.os = os;
    ...
    private Logger logger = Logger.getLogger(TabulatedAttributeQueryRunner.class.getName());
