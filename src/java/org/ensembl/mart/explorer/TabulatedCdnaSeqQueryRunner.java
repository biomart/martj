...
/**
 * Outputs cdna sequence in tabulated output format, with the sequence as the last field in the output.
 * 
 * @author <a href="mailto:dlondon@ebi.ac.uk">Darin London</a>
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public final class TabulatedCdnaSeqQueryRunner implements QueryRunner {
	 ...
	 */
	public TabulatedCdnaSeqQueryRunner(Query query, FormatSpec format, Connection conn, OutputStream os) {
	    this.query = query;
	    this.format = format;
	    this.conn = conn;
	    this.os = os;
