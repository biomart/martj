 ...
 * against Mart databases and export the results in a variety of
 * formats.
 */
public class MartExplorerApplication{
  ...
  /**
   * Examines the command line parameters and then passes them to the
   * appropriate front end implementation.
   **/
  public static void main(String[] args){
    ...
    if ( loggingURL!=null ) {
      ...
      // Initialise logging system to print to console messages of level >=
      // WARN unless the user sets the system property log4j.configuration.
    ...
    if ( commandline ) 
      ...
      new SwingFrontEnd(  engine, host, port, user, password ).run();
  }
