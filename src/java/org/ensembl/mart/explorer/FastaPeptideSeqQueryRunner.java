...
/**
 * Outputs peptide sequence in fasta output format
 * 
 * @author <a href="mailto:dlondon@ebi.ac.uk">Darin London</a>
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public final class FastaPeptideSeqQueryRunner implements QueryRunner {
	
	/**
	 * Constructs a FastaPeptideSeqQueryRunner object to execute a Query
	 * and print Fasta output of Peptide Sequences
	 * 
	 ...
	 */	
	public FastaPeptideSeqQueryRunner(Query query, FormatSpec format, Connection conn, OutputStream os) {
		this.query = query;
		this.format = format;
		this.conn = conn;
		this.os = os;
