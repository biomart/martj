...
public class SimpleLibraryUsageExample {
  ...
  public static void main(String[] args) throws FormatException, SequenceException, InvalidQueryException  {
    ...
    Engine engine =
      new Engine("kaka.sanger.ac.uk", "3306", "anonymous", "", "ensembl_mart_15_1");
