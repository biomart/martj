 ...
 */
public class DatasetViewXMLLoader {
  ...
  private static String dbtype = null;
	...
	private static Logger logger = Logger.getLogger(DatasetViewXMLLoader.class.getName());
			
	public static void main(String[] args) {
		LoggingUtils.setVerbose(false);
		
    //TODO: application to store DatasetView.xml data
//		try {
//	
